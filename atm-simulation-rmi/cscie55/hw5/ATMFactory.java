/**
 * $Id: ATMFactory.java, v 1.0 5/12/13 17:24 oscarfabra Exp $
...
{
    /**
     * Gets an ATM stub to be used by the Server process.
     *
     * @return ATM stub to be used by the Server
     * @throws RemoteException If the ATM stub couldn't be retrieved
     */
